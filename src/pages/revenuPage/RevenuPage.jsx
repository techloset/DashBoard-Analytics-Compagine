    ...
    <div className=' w-[100%] mt-[30px]  mx-auto xl:mx-0  flex flex-col justify-around items-center  xl:flex-row  xl:bg-[#ffffff] xl:flex font-Regular   xl:mt-[24px] xl:w-[1082px] xl:h-[169px]  border-2 border-solid rounded-[20px] border-[#ecedf6] shadow-[0_20px_50px_rgba(219,224,248,0.5)]'>
      ...
      <div className='flex w-full mt-[10px] xl:mt-0   xl:static'>
        ...
        <div className=' w-[50%] inline py-4 xl:py-0  mb-[10px] xl-mb-0  xl:p-0  xl:w-[211px] xl:h-[94px] xl:ml-[45px] xl:mr-[47px] xl:mt-[38px] xl:mb-[37px] '>
          ...
          <div className='flex items-center  justify-center  '>
            <div className='text-[11px] md:text-[16px] xl:text-[16px] font-[400] text-[#7d7d7d]  mx-3 xl:mx-0'>Available to witdraw</div>
          ...
          <p className='xl:text-[28px] flex justify-center items-center xl:block font-[700] text-[#1a2b88] font-BOLD  text-[22px]'>$1,567.99</p>
          <p className=' xl:text-[14px] flex justify-center items-center xl:block  font-[400] text-[#061148] font-Regular text-[10px]'>Wed, Jul 20</p>
        ...
        <div className=' w-[50%] py-4 xl:py-0 mb-[10px] xl-mb-0  xl:p-0  xl:w-[169px] xl:h-[96px] xl:ml-[47px] xl:mr-[47px]  xl:mt-[36px] xl:mb-[37px]  '>
          ...
          <div className='flex items-center  justify-center  '>
            <div className=' xl:text-[16px] font-[400] xl:w-[107px]  text-[11px] md:text-[16px]  mx-3 xl:mx-0'>Today Revenue</div>
          ...
          <p className='xl:text-[28px]  flex justify-center items-center xl:block font-[700] text-[#1a2b88] font-BOLD text-[22px]'> $2,868.99</p>
          <p className='xl:text-[14px]  flex justify-center items-center xl:block font-[400] text-[10px] text-[#000000]'>143 Orders</p>
      ...
      <div className='flex w-full  xl:static'>
        ...
        <div className='  mb-[10px] py-4 xl:py-0  w-[100%]  xl:p-0  xl:w-[168px] xl:h-[96px] xl:ml-[47px] xl:mr-[47px]  xl:mt-[36px] xl:mb-[37px] '>
          ...
          <div className='flex items-center  justify-center '>
            <div className=' xl:text-[16px] xl:w-[115px] font-[400] md:text-[16px] text-[11px]  mx-3 xl:mx-0 '>Today Sessions</div>
          ...
          <p className='xl:text-[28px]  flex justify-center items-center xl:block font-[700] text-[#1a2b88] font-BOLD text-[22px]'>156k</p>
          <p className='xl:text-[14px]  flex justify-center items-center xl:block text-[#000000]  font-[400]  text-[10px]'>32k Visitors</p>
        ...
        <div className='  w-[100%] py-4 xl:py-0 mb-[10px] xl:p-0    xl:w-[145px] xl:h-[96px] xl:ml-[47px] xl:mr-[66px] xl:mt-[36px] xl:mb-[37px]  '>
          ...
          <div className='flex items-center  justify-center '>
            <div className=' xl:text-[16px] font-[400] md:text-[16px] text-[11px] mx-3 xl:mx-0'>Subscribers</div>
          ...
          <p className='xl:text-[28px]  flex justify-center items-center xl:block font-[700] text-[#1a2b88] font-BOLD text-[22px] ' >3,422</p>
          <p className='xl:text-[14px] flex justify-center items-center xl:block  font-[400] text-[10px] text-[#000000] '>$34.28 Average Order</p>
