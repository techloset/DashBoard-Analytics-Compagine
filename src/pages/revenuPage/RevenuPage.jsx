...
{/* 1st */}
      ...
      <div className='xl:flex items-center  '>
          ...
          <div className='md:w-[50px]    xl:ml-[13px] flex items-center justify-center xl:w-[54px] xl:h-[21px] py-[3px] px-[4px] gap-[3px] bg-[#f4f6f6]  rounded-[50px] '>
        ...
        <p className=' xl:text-[14px] font-[400] text-[#061148] font-Regular md:text-[10px]'>Wed, Jul 20</p>
...
{/* 2nd  */}
      ...
      <div className='xl:flex  xl:items-center  '>
        ...
        <p className='xl:text-[14px] font-[400] md:text-[10px] text-[#000000]'>143 Orders</p>
...
{/* 3rd */}
      ...
      <div className='xl:flex  xl:items-center '>
        ...
        <p className='xl:text-[14px] text-[#000000]  font-[400]  md:text-[10px]'>32k Visitors</p>
...
{/* 4th */}
      <div className=' md:p-4 xl:p-0    xl:w-[145px] xl:h-[96px] xl:ml-[47px] xl:mr-[66px] xl:mt-[36px] xl:mb-[37px]  '>
        ...
        <p className='xl:text-[14px] font-[400] md:text-[10px] text-[#000000] '>$34.28 Average Order</p>
